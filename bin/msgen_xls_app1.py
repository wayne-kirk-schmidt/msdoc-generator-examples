...
PARSER.add_argument('-b', metavar='<branding>', dest='branding', \
                    default='www.clearbit.com', help='specify brand logo')
...
SUMOURL = f"https://logo.clearbit.com/{ARGS.branding}"
...
pie_chart.add_series({
    'name': 'Breakdown',
    'categories': '=Graph!$A$2:$A$' + str(ROW),
    'values':     '=Graph!$B$2:$B$' + str(ROW),
})
